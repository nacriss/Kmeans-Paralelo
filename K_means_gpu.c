...
// Declarar a função para ser compilada para a GPU
...
// ALTERAÇÃO 2: Mapear os dados estruturados para a GPU durante o laço principal
...
// Atualizar clusters na GPU com os dados recém-calculados na CPU
#pragma omp target update to(clusters[0 : k])

// Descarregar o laço pesado de busca de vizinhos mais próximos para a GPU
